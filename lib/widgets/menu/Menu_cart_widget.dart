              ...
              Container(
                ...
                child: ListView.builder(
                  ...
                  itemBuilder: (BuildContext context, int index) {
                    ...
                    List<Items> items = _menuPaperController.allItemsForCategory[widget.IndexCount]; // .allItemsForCategory[widget.IndexCount];
                    if (widget.IndexCount == 0 && index == 0) {
                      items.shuffle();
                    }
                    return DishCardWidget(
                      testName: '${items[index].item?.title}',
                      imagePath: '${items[index].item?.image}',
                      itemCosts: '${items[index].item?.price}',
                      model: items[index],
                    );
                  },
