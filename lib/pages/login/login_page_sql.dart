...
class _LoginPageSQLState extends State<LoginPageSQL> {
  ...
  Widget build(BuildContext context) {
    ...
    return WillPopScope(
        ...
        child: GetBuilder<AuthController>(builder: (_authControlle){
          //TODO: CustomLoader с черным фоном перекрывает станицу
          return Scaffold(
            backgroundColor: AppColors.mainColor,
            body: SafeArea(
              child: !_authControlle.isLoading?SingleChildScrollView(
                child: Center(
                  child: Padding(
